            ...
            items: [
              {
                ...
                image: "Evolution-Series-Pump_1_upqdp0",
                specs: [
                  "To reduce wastage of high valued material",
                  "To eliminate spillage or leakage of media",
                  "To eliminate cleaning cost of pump & surrounding",
                  " 50% Reduction in maintenance time",
                  "50% Reduction in maintenance cost",
                  "Detect dead head condition & dry run condition",
                ],
              },
              {
                ...
                specs: [
                  "Delivering maximum flow rate and lesser air consumption",
                  "Robust diaphragm connecting rod",
                  "Crossed drilled directional spool valve",
                  "Top discharge porting eliminates entrained air",

                  'Size: ¼" to 3"',
                  "Flow upto: 1060 lpm",
                  'Solid Handling : 0.03" to 0.75" (1 mm to 19 mm)',
                  "Displacement / Stroke:  0.01 to 1.0 gallon (0.04 to 8 liters)",
                  "Construction: Aluminum, Cast Iron, Stainless Steel, Alloy C",
                  "Elastomers: (Diaphragm, Ball Valve and Valve seats) : Nitrile,Neoprene, santoprene, PTFE, Viton, Hytrel, EPDM",
                ],
              },
              {
                ...
                specs: [
                  "For fluids containing up to line size solids",
                  "Diaphragm wear pad",
                  "Bottom discharge porting",
                  "Stainless steel check valve seats",
                  "Superior suction lift ",

                  'Size: 1" to 4" (25 mm to 102 mm)',
                  "Flow: upto 984 lpm",
                  'Solid Handling:1" to 3" (25-76mm)',
                  "Displacement / Stroke: 0.1 to 1.5 gallons (0.38 to 5.7 liters)",
                  "Construction :Aluminum, Cast Iron, Stainless Steel, Polypropylene",
                ],
              },
              {
                ...
                specs: [
                  "For fluid containment, protecting people,environment and pump",

                  "No lost system fluid",
                  "Visual, electronic and mechanical leak detection is possible",
                  "No costly clean up",

                  'Size: 1" to 3" (25 mm to 76 mm)',
                  "Flow: upto 901 lpm",
                  'Solid Handling:0.25" to 0.71" (6-18 mm)',
                  "Displacement / Stroke:0.09 to 0.9 gallons (0.34 to 3.4 liters)",
                  "Construction :Aluminum, Cast Iron, Stainless Steel, Polypropylene",
                ],
              },
              {
                ...
                specs: [
                  "For fluids containing settling, suspended & floating solids",

                  "Thick manifold and chamber walls",
                  "Heavy duty actuator plungers",
                  "Down and top ported options",
                  'For 1" and 1 1/2", side ported option available',
                  "Weighted ball valve",

                  'Size: 1" to 4" (25 mm to 102 mm)',
                  "Flow: upto 984 lpm",
                  'Solid Handling:0.25" to 0.875" (6 - 22mm)',
                  "Displacement / Stroke:0.9 to 1.8 Gallons (0.34 to 6.8 Liters)",
                  "Construction :Aluminum, Cast Iron, Stainless Steel, Alloy C",
                ],
              },
            ],
            ...
            items: [
              {
                ...
                image: "ss_ajpalx",
                specs: [
                  "UNIVERSAL PRODUCT LINE SERIES: 127A, 4127A STAINLESS STEEL CONSTRUCTION A gear pump comes under the category of positive displacement pump that has a continuous rotary delivery pump. ",

                  "All stainless-steel gear pumps have construction that is corrosion resistant over a wider pH range.",
            ...
            items: [
              {
                ...
                image: "pulsapro-img_iibxzd",
                specs: [
                  "FLOW:UP TO 248 GPH (939 LPH)",
                  "PRESSURE:UP TO 3,100 PSI (213.7 BAR)",
                  "TEMPERATURE:UP TO 300°F (148°C)",
                  "APPLICATIONS",
                  "Injection of Corrosion inhibitors for oil & gas products conveyance.",
                  "Injection of Anti-scalants in pipes using PulsaPro® 7120 pumps.",
                  "Easily handle high viscosity fluids like Slurries.",
                  "Disinfection of the pipes with Sodium Hypochlorite with PulsaPro® 7120.",
                  "pH and odor control with lime slurries using PulsaPro® 7120 pumps.",
                ],
              },
              {
                name: "Pulsa 7440",
                ...
                specs: [
                  ...
                  "Accuracy (Manual) – +/- 1.0% of set point capacity",
                  "Process temperature Metal reagent head with Teflon diaphragm -29 to 121°C",
                  "Viscosity Range – 0.1 to 1000 cP",
                  "NPIPr – 5 psi",
                  "Materials of construction:Reagent head and Valve caps – 316L , Alloy 20, Alloy C and Monel",
                  "Check Valves-316L, Alloy 20, Alloy C and others (Tungsten Carbide)",
                  "Diaphragm- PTFE Single or Double diaphragm design",
                ],
              },
              {
                name: "Pulsa Pro 680",
                ...
                specs: [
                  "Pump Design – Hydraulically actuated diaphragm design complying to API-675 3rd edition.",
                  "Flows and Pressures – 0.4 to 768 LPH with a simplex & Pressures to 220 Bar",
                  "Accuracy (Manual) – +/- 0.5% of set point capacity",
                  "Process temperature Metal reagent head with Teflon diaphragm -29 to 121 °C (-20 to 250 °F)",
                  "Viscosity Range – 0.1 to 1000 cP",
                  "NPIPr – 5 psi",
                  "Materials of construction",
                  "Reagent head and Valve caps – 316L, Alloy 20, Alloy C and Monel",
                  "Check Valves-316L, Alloy 20, Alloy C and others (Tungsten Carbide)",
                  "Diaphragm- PTFE Single or Double diaphragm design",
                ],
              },
      ...
      },
      {
        ...
        subcategories: [
          ...
          },
          {
            ...
            image:
              "dust-filter-bag-dust-curtain-and-mild-steel-structure_g2fkcc",
            items: [
              {
                name: "Mild Steel Structure",
