    ...
    categories: [
      {
        ...
        subcategories: [
          ...
          {
            name: "MOVIGEAR ",
            href: "/products/sew/gear-motors/movigear",
            items: [],
          },
          {
            name: "MOVITMOT Gear Motor ",
            href: "/products/sew/gear-motors/movimot",
            slug: "movimot",
          },
          {
            name: "MOVIFIT Gear Motor",
            href: "/products/sew/gear-motors/movifit",
            slug: "movifit",
          },
          {
            name: "Industrial Gear units ",
            href: "/products/sew/gear-motors/industrial-gear-units",
            slug: "industrial-gear-units",
          },
          {
            name: "P & XP Series ",
            href: "/products/sew/gear-motors/p-xp-series",
            slug: "p-xp-series",
          },
          {
            name: "MOVITRAC Inverter MCO7B",
            href: "/products/sew/gear-motors/movitrack",
            slug: "movitrack",
          },
          {
            name: "MoviDrive Inverter MDX61B   ",
            href: "/products/sew/gear-motors/movidrive",
            slug: "movidrive",
          },
        ],
      },
      {
        ...
        subcategories: [
          {
            name: "MOVIGEAR",
            href: "/products/sew/mechatronic-drive-systems/movigear",
            items: [
              {
                name: "MOVIGEAR DBC",
          ...
          {
            name: "MOVIMOT",
            href: "/products/sew/mechatronic-drive-systems/movimot",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
          ...
          {
            name: "MOVIFIT",
            href: "/products/sew/mechatronic-drive-systems/movifit",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
    ...
    categories: [
      {
        ...
        subcategories: [
          ...
          },
          {
            ...
            items: [
              {
                name: "Flamem Proof Motors(IE1/IE2)",
    ...
    categories: [
        ...
        subcategories: [
          {
            ...
            href: "/products/index-pumps/air-operated/standard-metallic",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
          ...
          },
          {
            ...
            href: "/products/index-pumps/air-operated/standard-non-metallic",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
      ...
      },
      {
        ...
        subcategories: [
          {
            name: "2″ EODD PUMP",
            href: "/products/index-pumps/eodd/2-inch",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
          ...
          {
            name: "3″ EODD PUMP",
            href: "/products/index-pumps/eodd/3-inch",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
  ...
  },
  {
    ...
    categories: [
        ...
        subcategories: [
          {
            ...
            href: "/products/nalco/water-treatment/cooling",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
          ...
          },
          {
            ...
            href: "/products/nalco/water-treatment/boiler",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
      ...
      },
      {
        ...
        subcategories: [
          {
            name: "3D TRASAR Technology",
            href: "/products/nalco/monitoring/3d-trasar",
            items: [
              {
                name: "MOVIGEAR DBC",
                href: "/products/sew/mechatronic-drive-systems/movigear/dbc",
