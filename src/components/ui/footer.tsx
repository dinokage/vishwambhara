          ...
          <div className="grid grid-col-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm mb-4">
                An exclusive One-Stop Facility for guaranteed energy efficient solutions related
to Air Compressors, Pumps, Valves, Geared motors, Material handling, Electric Motors, Industrial Coding Systems & Cleaning System.
              </p>
              <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-sm">
                  ...
                  <br /># 39-11-3/2, 1st Floor, Above Punjab National Bank, Muraliinagar, Bank Street,
                  Sector -11,
                  <br />
                  Visakhapatnam - 530007, AP, India.
                </p>
                <p className="text-sm">info@classique.co.in & sales@classique.co.in</p>
          ...
          <div className="border-t border-[#606060] mt-8 pt-4 text-xs text-center">
            <p>
              • Terms & Conditions - Privacy Policy - Sitemap &nbsp;&nbsp; powered by <a href="https://hextasphere.com" target='_blank'>Hextasphere</a>{" "}
